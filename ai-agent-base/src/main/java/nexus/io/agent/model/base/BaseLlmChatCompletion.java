...
public abstract class BaseLlmChatCompletion<M extends BaseLlmChatCompletion<M>> extends Model<M> implements IBean {
	...
	public M setRequest(java.lang.String request) {
		set("request", request);
		return (M)this;
	}
