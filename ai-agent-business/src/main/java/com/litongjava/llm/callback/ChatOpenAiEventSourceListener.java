...
public class ChatOpenAiEventSourceListener extends EventSourceListener {
  ...
  private final ApiChatSendVo apiChatSendVo;
  ...
  public ChatOpenAiEventSourceListener(ChannelContext channelContext, ApiChatSendVo apiChatSendVo, long answerId, long startTs, String textQuestion) {
    this(channelContext, apiChatSendVo, answerId, startTs, textQuestion, null);
  }

  public ChatOpenAiEventSourceListener(ChannelContext channelContext, ApiChatSendVo apiChatSendVo, long answerId, long startTs, String textQuestion, CountDownLatch latch) {
