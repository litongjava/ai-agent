...
import nexus.io.llm.service.FollowUpQuestionService;
...
public class ChatOpenAiEventSourceListener extends EventSourceListener {
  ...
  public ChatOpenAiEventSourceListener(ChannelContext channelContext, ChatAskRequest apiChatSendVo, long answerId, long startTs,
      String textQuestion) {
